...
namespace IIS.Snezhana4
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhana4.Способ1 fСпособ;
        
        private System.DateTime fДата;
        
        private double fСумма;
        
        private IIS.Snezhana4.Заказ fЗаказ;
        ...
        public virtual IIS.Snezhana4.Способ1 Способ
        {
            get
            {
                ...
                IIS.Snezhana4.Способ1 result = this.fСпособ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Snezhana4.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.Snezhana4.Заказ Заказ
        {
            get
            {
                ...
                IIS.Snezhana4.Заказ result = this.fЗаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОплатаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОплатаE", typeof(IIS.Snezhana4.Оплата));
                }
            }
        }
    }
    ...
    public class DetailArrayOfОплата : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Snezhana4.DetailArrayOfОплата members)

        // *** End programmer edit section *** (IIS.Snezhana4.DetailArrayOfОплата members)
        ...
        /// </summary>
        public DetailArrayOfОплата(IIS.Snezhana4.Заказ fЗаказ) : 
                base(typeof(Оплата), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.Snezhana4.Оплата this[int index]
        {
            get
            {
                return ((IIS.Snezhana4.Оплата)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Snezhana4.Оплата dataobject)
        {
